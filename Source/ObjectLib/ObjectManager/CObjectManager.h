...
private:
	...
	// The Pointer to the Boss.
	IBaseObject* m_pSludge;
	IBaseObject* m_pSludgesShip;
...
public:
	...
	IBaseObject* GetSludge() { return m_pSludge; }
	IBaseObject* GetSludgesShip() { return m_pSludgesShip; }
	...
	// Last Modification Date:
	/////////////////////////////////////////////////////////////////////////////////////////////////////
	IBaseObject* CreateObject ( eOBJECT_TYPE eType, D3DXMATRIX _ObjectMatrix, char _LevelID, IBaseObject* _partner = nullptr );
	...
	// Last Modification Date:
	/////////////////////////////////////////////////////////////////////////////////////////////////////
	IBaseObject* CreateAnimatedBGObject ( eOBJECT_TYPE eType, D3DXMATRIX _ObjectMatrix, const char* _szRenderNode, State* _AnimationState, char _levelId );
	...
	// Last Modification Date:
	/////////////////////////////////////////////////////////////////////////////////////////////////////
	void ResetAllHazardsandMoveableObjects(void);
	...
	// Last Modification Date:
	/////////////////////////////////////////////////////////////////////////////////////////////////////
	void ClearObjectByLevel( char _id );
