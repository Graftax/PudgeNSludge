...
public:
	...
	// Mod. Date: 5/24/12
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	bool LoadCollisionEnvironment(const char* szInfiniteHPLevelName, char _levelID);
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Mod. Date: 5/24/12
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	bool LoadEnvironmentTraps( const char* szInfiniteHPLevelTrapFile, const char* szInfiniteHPLevelTrapDataFile, char _levelId );
	...
	// Mod. Date: 5/24/12
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	bool LoadEnvironmentMoveableObjects( const char* szInfiniteHPLevelObjectsFile, const char* szInfiniteHPLevelObjectsFileData, char _levelId );
        /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	CCollisionVolume* GetCollisionVolume( const char* _meshName );
        CCollisionVolume* GetCollisionVolume( RenderNode* node );
	...
	void _LoadBoundingVolumesForAnimatedMeshes( AnimatedMesh* ToFill, int _meshIndex, D3DXMATRIX meshMatrix );


	void LoadHazard(const char* szInfiniteHPMeshName, CCollisionAABB& volume, D3DXMATRIX transformMat );
	int LoadHazardMeshFromFile( const char* InfiniteHPMeshData, Mesh** newMesh );
	CCollisionAABB _GenerateVolumesForHazards( Mesh* ToFill, D3DXMATRIX meshMatrix );
