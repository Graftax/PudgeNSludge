...
class CCollisionFrustum;
class CCollisionAABB;
class RenderTarget;
class LightManager;
class CVideoOptionsState;
class PostProcess;
...
#define BURN_RATE 0.00135f
#define DEBUGSHAPES 0
...
private:
	...
	friend class CVideoOptionsState;
...
////////////////////////////////////////////////////////////////
	...
	static RenderTarget m_rtSharp;

#if DEPTHOFFIELD	
	static PostProcess m_DepthOfField;
	static PostProcess m_BlurH;
	static PostProcess m_BlurV;
#endif

	static PostProcess m_DownSample;
	static PostProcess m_UpSample;
	static PostProcess m_DrawEdges;
	
	static PostProcessChain m_PostProcessChain;
	static PostProcessChain m_EmissiveChain;

	static CParticleManager* m_pParticleManager;

	static float m_fGammaFactor;
	static float m_fPlayerHealth;
	...
	static CCollisionFrustum ViewFrustum;
...
public:
	...
	static void SetObjPulled(bool _bObjPulled) {}
	...
	// Mod. Date: 5/24/12
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	static bool InitRenderEngine(HWND hWnd, HINSTANCE hInstance, int nScreenWidth, int nScreenHeight, bool bFullScreen, bool bVsync, D3DXVECTOR3 _v3ClearColor );
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Mod. Date: 5/24/12
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	static void ChangeDisplayParam( int nScreenWidth, int nScreenHeight, bool bFullScreen, bool bVsync );
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	static void BuildFrustum( float FoV, float nearDist, float farDist, float aspectRatio, matrix4f cameraWorld );

	static CCollisionFrustum* GetFrustum(void);

	static void RenderViewFrustum(void);
	...
	static void SetPlayerHealth(float _Health) { m_fPlayerHealth = _Health; }
