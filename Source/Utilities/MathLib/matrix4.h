...
struct matrix4
{
   ...
   template <typename VT>
	...
	template <typename T>
	friend void Inverse( matrix4<T> *Out, const matrix4<T> *In );
...
template <typename T>
void Inverse( matrix4<T> *Out, const matrix4<T> *In )
{
	float inv[16], det;
	int i;

	inv[0] = In->ma[5]  * In->ma[10] * In->ma[15] - 
				In->ma[5]  * In->ma[11] * In->ma[14] - 
				In->ma[9]  * In->ma[6]  * In->ma[15] + 
				In->ma[9]  * In->ma[7]  * In->ma[14] +
				In->ma[13] * In->ma[6]  * In->ma[11] - 
				In->ma[13] * In->ma[7]  * In->ma[10];

	inv[4] = -In->ma[4]  * In->ma[10] * In->ma[15] + 
				In->ma[4]  * In->ma[11] * In->ma[14] + 
				In->ma[8]  * In->ma[6]  * In->ma[15] - 
				In->ma[8]  * In->ma[7]  * In->ma[14] - 
				In->ma[12] * In->ma[6]  * In->ma[11] + 
				In->ma[12] * In->ma[7]  * In->ma[10];

	inv[8] = In->ma[4]  * In->ma[9] * In->ma[15] - 
				In->ma[4]  * In->ma[11] * In->ma[13] - 
				In->ma[8]  * In->ma[5] * In->ma[15] + 
				In->ma[8]  * In->ma[7] * In->ma[13] + 
				In->ma[12] * In->ma[5] * In->ma[11] - 
				In->ma[12] * In->ma[7] * In->ma[9];

	inv[12] = -In->ma[4]  * In->ma[9] * In->ma[14] + 
				In->ma[4]  * In->ma[10] * In->ma[13] +
				In->ma[8]  * In->ma[5] * In->ma[14] - 
				In->ma[8]  * In->ma[6] * In->ma[13] - 
				In->ma[12] * In->ma[5] * In->ma[10] + 
				In->ma[12] * In->ma[6] * In->ma[9];

	inv[1] = -In->ma[1]  * In->ma[10] * In->ma[15] + 
				In->ma[1]  * In->ma[11] * In->ma[14] + 
				In->ma[9]  * In->ma[2] * In->ma[15] - 
				In->ma[9]  * In->ma[3] * In->ma[14] - 
				In->ma[13] * In->ma[2] * In->ma[11] + 
				In->ma[13] * In->ma[3] * In->ma[10];

	inv[5] = In->ma[0]  * In->ma[10] * In->ma[15] - 
				In->ma[0]  * In->ma[11] * In->ma[14] - 
				In->ma[8]  * In->ma[2] * In->ma[15] + 
				In->ma[8]  * In->ma[3] * In->ma[14] + 
				In->ma[12] * In->ma[2] * In->ma[11] - 
				In->ma[12] * In->ma[3] * In->ma[10];

	inv[9] = -In->ma[0]  * In->ma[9] * In->ma[15] + 
				In->ma[0]  * In->ma[11] * In->ma[13] + 
				In->ma[8]  * In->ma[1] * In->ma[15] - 
				In->ma[8]  * In->ma[3] * In->ma[13] - 
				In->ma[12] * In->ma[1] * In->ma[11] + 
				In->ma[12] * In->ma[3] * In->ma[9];

	inv[13] = In->ma[0]  * In->ma[9] * In->ma[14] - 
				In->ma[0]  * In->ma[10] * In->ma[13] - 
				In->ma[8]  * In->ma[1] * In->ma[14] + 
				In->ma[8]  * In->ma[2] * In->ma[13] + 
				In->ma[12] * In->ma[1] * In->ma[10] - 
				In->ma[12] * In->ma[2] * In->ma[9];

	inv[2] = In->ma[1]  * In->ma[6] * In->ma[15] - 
				In->ma[1]  * In->ma[7] * In->ma[14] - 
				In->ma[5]  * In->ma[2] * In->ma[15] + 
				In->ma[5]  * In->ma[3] * In->ma[14] + 
				In->ma[13] * In->ma[2] * In->ma[7] - 
				In->ma[13] * In->ma[3] * In->ma[6];

	inv[6] = -In->ma[0]  * In->ma[6] * In->ma[15] + 
				In->ma[0]  * In->ma[7] * In->ma[14] + 
				In->ma[4]  * In->ma[2] * In->ma[15] - 
				In->ma[4]  * In->ma[3] * In->ma[14] - 
				In->ma[12] * In->ma[2] * In->ma[7] + 
				In->ma[12] * In->ma[3] * In->ma[6];

	inv[10] = In->ma[0]  * In->ma[5] * In->ma[15] - 
				In->ma[0]  * In->ma[7] * In->ma[13] - 
				In->ma[4]  * In->ma[1] * In->ma[15] + 
				In->ma[4]  * In->ma[3] * In->ma[13] + 
				In->ma[12] * In->ma[1] * In->ma[7] - 
				In->ma[12] * In->ma[3] * In->ma[5];

	inv[14] = -In->ma[0]  * In->ma[5] * In->ma[14] + 
				In->ma[0]  * In->ma[6] * In->ma[13] + 
				In->ma[4]  * In->ma[1] * In->ma[14] - 
				In->ma[4]  * In->ma[2] * In->ma[13] - 
				In->ma[12] * In->ma[1] * In->ma[6] + 
				In->ma[12] * In->ma[2] * In->ma[5];

	inv[3] = -In->ma[1] * In->ma[6] * In->ma[11] + 
				In->ma[1] * In->ma[7] * In->ma[10] + 
				In->ma[5] * In->ma[2] * In->ma[11] - 
				In->ma[5] * In->ma[3] * In->ma[10] - 
				In->ma[9] * In->ma[2] * In->ma[7] + 
				In->ma[9] * In->ma[3] * In->ma[6];

	inv[7] = In->ma[0] * In->ma[6] * In->ma[11] - 
				In->ma[0] * In->ma[7] * In->ma[10] - 
				In->ma[4] * In->ma[2] * In->ma[11] + 
				In->ma[4] * In->ma[3] * In->ma[10] + 
				In->ma[8] * In->ma[2] * In->ma[7] - 
				In->ma[8] * In->ma[3] * In->ma[6];

	inv[11] = -In->ma[0] * In->ma[5] * In->ma[11] + 
				In->ma[0] * In->ma[7] * In->ma[9] + 
				In->ma[4] * In->ma[1] * In->ma[11] - 
				In->ma[4] * In->ma[3] * In->ma[9] - 
				In->ma[8] * In->ma[1] * In->ma[7] + 
				In->ma[8] * In->ma[3] * In->ma[5];

	inv[15] = In->ma[0] * In->ma[5] * In->ma[10] - 
				In->ma[0] * In->ma[6] * In->ma[9] - 
				In->ma[4] * In->ma[1] * In->ma[10] + 
				In->ma[4] * In->ma[2] * In->ma[9] + 
				In->ma[8] * In->ma[1] * In->ma[6] - 
				In->ma[8] * In->ma[2] * In->ma[5];

	det = In->ma[0] * inv[0] + In->ma[1] * inv[4] + In->ma[2] * inv[8] + In->ma[3] * inv[12];
