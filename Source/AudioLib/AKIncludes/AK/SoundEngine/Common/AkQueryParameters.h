...
namespace AK
{
	...
	namespace SoundEngine
	{
		...
		namespace Query
		{
			...
			/// AK_InvalidParameter
			AK_EXTERNAPIFUNC( AKRESULT, GetGameObjectEnvironmentsValues )( 
				AkGameObjectID		in_gameObjectID,		///< Associated game object ID
			...
			/// \return AK_Success if succeeded
			AK_EXTERNAPIFUNC( AKRESULT, GetEnvironmentVolume )( 
			...
			/// - \ref soundengine_environments_setting_environment_volume
			/// \return AK_Success if succeeded
			AK_EXTERNAPIFUNC( AKRESULT, GetEnvironmentVolumes )( 
			...
			/// - \ref soundengine_environments_id_vs_string
			/// \return AK_Success if succeeded
			AK_EXTERNAPIFUNC( AKRESULT, GetEnvironmentBypass )(
				AkEnvID	in_FXParameterSetID,				///< Environment ID
