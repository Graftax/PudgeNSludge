...
namespace AK
{
	namespace DSP
	{
			...
			AkUInt32 in_uNumFrames )
		{
			...
			while ( pfBuf < pfVecEnd )
			{
				AKSIMD_V2F32 vfIn1 = AKSIMD_LOAD_V2F32( pfBuf, 0 );
				AKSIMD_V2F32 vfIn2 = AKSIMD_LOAD_V2F32( pfBuf, 8 );
				AKSIMD_V2F32 vfIn3 = AKSIMD_LOAD_V2F32( pfBuf, 16 );
				AKSIMD_V2F32 vfIn4 = AKSIMD_LOAD_V2F32( pfBuf, 24 );
				...
				vfGain = vGainRamp.Tick();
				AKSIMD_STORE_V2F32( pfBuf, 0, vfOut1 );
				AKSIMD_STORE_V2F32( pfBuf, 8, vfOut2 );
				AKSIMD_STORE_V2F32( pfBuf, 16, vfOut3 );
				AKSIMD_STORE_V2F32( pfBuf, 24, vfOut4 );
				pfBuf+=8;
			}
			/*
			...
			while ( pfBuf < pfVecEnd )
			{
				AKSIMD_V2F32 vfIn = AKSIMD_LOAD_V2F32( pfBuf, 0 );
				AKSIMD_V2F32 vfOut = AKSIMD_MUL_V2F32( vfIn, vfGain );
				AKSIMD_STORE_V2F32( pfBuf, 0, vfOut );
				vfGain = vGainRamp.Tick();
				pfBuf+=2;
			}
			*/
			...
			AkUInt32 in_uNumFrames )
		{
			...
			while ( pfInBuf < pfVecEnd )
			{
				AKSIMD_V2F32 vfIn = AKSIMD_LOAD_V2F32( pfInBuf, 0 );
				AKSIMD_V2F32 vfOut = AKSIMD_MUL_V2F32( vfIn, vfGain );
				AKSIMD_STORE_V2F32( pfOutBuf, 0, vfOut );
				vfGain = vGainRamp.Tick();
				pfInBuf+=2;
				pfOutBuf+=2;
			}
			...
			AkUInt32 in_uNumFrames )
		{
			...
			while ( pfInBuf < pfVecEnd )
			{
				AKSIMD_V2F32 vfIn1 = AKSIMD_LOAD_V2F32( pfInBuf, 0 );
				AKSIMD_V2F32 vfIn2 = AKSIMD_LOAD_V2F32( pfInBuf, 8 );
				AKSIMD_V2F32 vfIn3 = AKSIMD_LOAD_V2F32( pfInBuf, 16 );
				AKSIMD_V2F32 vfIn4 = AKSIMD_LOAD_V2F32( pfInBuf, 24 );
				pfInBuf+=8;
				AKSIMD_V2F32 vfOut1 = AKSIMD_MUL_V2F32( vfIn1, vfGain );
				AKSIMD_V2F32 vfOut2 = AKSIMD_MUL_V2F32( vfIn2, vfGain );
				AKSIMD_V2F32 vfOut3 = AKSIMD_MUL_V2F32( vfIn3, vfGain );
				AKSIMD_V2F32 vfOut4 = AKSIMD_MUL_V2F32( vfIn4, vfGain );
				AKSIMD_STORE_V2F32( pfOutBuf, 0, vfOut1 );
				AKSIMD_STORE_V2F32( pfOutBuf, 8, vfOut2 );
				AKSIMD_STORE_V2F32( pfOutBuf, 16, vfOut3 );
				AKSIMD_STORE_V2F32( pfOutBuf, 24, vfOut4 );
				pfOutBuf+=8;
			}
			/*
			const AkUInt32 uNumVecIter = in_uNumFrames/2;
