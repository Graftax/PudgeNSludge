...
namespace AK
{
	namespace Monitor
	{
		const AkOSChar* s_aszErrorCodes[ Num_ErrorCodes ] =
		{
			...
			AKTEXT("Invalid Group ID"), // ErrorCode_InvalidGroupID,
			...
			AKTEXT("Cannot in sound that is within a continuous container with special transitions"), // ErrorCode_CannotSeekContinuous
