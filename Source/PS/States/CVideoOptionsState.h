...
private:
	...
	int m_lpCurrentSelection;

	bool m_bFullScreen;
	bool m_bPrevDown;
	bool m_bLocked;			//this is telling us that the slider is selected

	//TEXTURES TO RENDER
	// Backgrounds
	//LPDIRECT3DTEXTURE9 m_lpOptionsVideoBright;
	int m_lpOptionsVideoGamma;
	int m_lpOptionsVideoExit;
	int m_lpOptionsVideoFS_On;
	int m_lpOptionsVideoFS_Off;
	int m_lpOptionsSlider;
	int m_lpOptionsCheck;
	int m_lpFullScreenBlockOut;
