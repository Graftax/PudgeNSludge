...
SlimeMonsterStunState::~SlimeMonsterStunState(void)
{
}

// Access the state to set it in the state machine for each component.
SlimeMonsterStunState* SlimeMonsterStunState::GetState(void)
{
	static SlimeMonsterStunState state;
	return &state;
}

// This will set all variables needed for this animation.
void SlimeMonsterStunState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("SlimeMonster_Stun") );
...
void SlimeMonsterStunState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SlimeMonsterStunState::Exit( CComponent_Animation* pComponent )
{
