...
SludgeFallCrusherAttackState::~SludgeFallCrusherAttackState(void)
{
}

// Access the state to set it in the state machine for each component.
SludgeFallCrusherAttackState* SludgeFallCrusherAttackState::GetState(void)
{
	static SludgeFallCrusherAttackState state;
	return &state;
}

// This will set all variables needed for this animation.
void SludgeFallCrusherAttackState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("Sludge_FallCrusherAttack") );
...
void SludgeFallCrusherAttackState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SludgeFallCrusherAttackState::Exit( CComponent_Animation* pComponent )
{
