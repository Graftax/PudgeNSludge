...
SludgesShipSpinAttackState::~SludgesShipSpinAttackState(void)
{
}

// Access the state to set it in the state machine for each component.
SludgesShipSpinAttackState* SludgesShipSpinAttackState::GetState(void)
{
	static SludgesShipSpinAttackState state;
	return &state;
}

// This will set all variables needed for this animation.
void SludgesShipSpinAttackState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("SludgesShip_SpinAttack") );
...
void SludgesShipSpinAttackState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SludgesShipSpinAttackState::Exit( CComponent_Animation* pComponent )
{
