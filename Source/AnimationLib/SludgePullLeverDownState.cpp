...
SludgePullLeverDownState::~SludgePullLeverDownState(void)
{
}

// Access the state to set it in the state machine for each component.
SludgePullLeverDownState* SludgePullLeverDownState::GetState(void)
{
	static SludgePullLeverDownState state;
	return &state;
}

// This will set all variables needed for this animation.
void SludgePullLeverDownState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("Sludge_PullLever") );
...
void SludgePullLeverDownState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SludgePullLeverDownState::Exit( CComponent_Animation* pComponent )
{
