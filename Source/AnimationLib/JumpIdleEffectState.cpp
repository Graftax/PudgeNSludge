...
JumpIdleEffectState::~JumpIdleEffectState(void)
{
}

// Access the state to set it in the state machine for each component.
JumpIdleEffectState* JumpIdleEffectState::GetState(void)
{
	static JumpIdleEffectState state;
	return &state;
}

// This will set all variables needed for this animation.
void JumpIdleEffectState::Enter( CComponent_Animation* pComponent )
{
...
void JumpIdleEffectState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void JumpIdleEffectState::Exit( CComponent_Animation* pComponent )
{
