...
SlimeMonsterThrowAttackState::~SlimeMonsterThrowAttackState(void)
{
}

// Access the state to set it in the state machine for each component.
SlimeMonsterThrowAttackState* SlimeMonsterThrowAttackState::GetState(void)
{
	static SlimeMonsterThrowAttackState state;
	return &state;
}

// This will set all variables needed for this animation.
void SlimeMonsterThrowAttackState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("SlimeMonster_ThrowAttack") );
...
void SlimeMonsterThrowAttackState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SlimeMonsterThrowAttackState::Exit( CComponent_Animation* pComponent )
{
