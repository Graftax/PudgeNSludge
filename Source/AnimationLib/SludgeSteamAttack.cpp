...
SludgeSteamAttackState::~SludgeSteamAttackState(void)
{
}

// Access the state to set it in the state machine for each component.
SludgeSteamAttackState* SludgeSteamAttackState::GetState(void)
{
	static SludgeSteamAttackState state;
	return &state;
}

// This will set all variables needed for this animation.
void SludgeSteamAttackState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("Sludge_SteamAttack") );
...
void SludgeSteamAttackState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SludgeSteamAttackState::Exit( CComponent_Animation* pComponent )
{
