...
SlimeMonsterHideState::~SlimeMonsterHideState(void)
{
}

// Access the state to set it in the state machine for each component.
SlimeMonsterHideState* SlimeMonsterHideState::GetState(void)
{
	static SlimeMonsterHideState state;
	return &state;
}

// This will set all variables needed for this animation.
void SlimeMonsterHideState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("SlimeMonster_Hide") );
...
void SlimeMonsterHideState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SlimeMonsterHideState::Exit( CComponent_Animation* pComponent )
{
