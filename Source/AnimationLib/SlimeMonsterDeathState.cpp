...
SlimeMonsterDeathState::~SlimeMonsterDeathState(void)
{
}

// Access the state to set it in the state machine for each component.
SlimeMonsterDeathState* SlimeMonsterDeathState::GetState(void)
{
	static SlimeMonsterDeathState state;
	return &state;
}

// This will set all variables needed for this animation.
void SlimeMonsterDeathState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("SlimeMonster_Death") );
...
void SlimeMonsterDeathState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SlimeMonsterDeathState::Exit( CComponent_Animation* pComponent )
{
