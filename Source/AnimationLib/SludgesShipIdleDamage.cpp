...
SludgesShipIdleDamage::~SludgesShipIdleDamage(void)
{
}

// Access the state to set it in the state machine for each component.
SludgesShipIdleDamage* SludgesShipIdleDamage::GetState(void)
{
	static SludgesShipIdleDamage state;
	return &state;
}

// This will set all variables needed for this animation.
void SludgesShipIdleDamage::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("SludgesShip_IdleDamaged") );
...
void SludgesShipIdleDamage::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SludgesShipIdleDamage::Exit( CComponent_Animation* pComponent )
{
