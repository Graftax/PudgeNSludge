...
VacuumArmIdleState::~VacuumArmIdleState(void)
{
}

// Access the state to set it in the state machine for each component.
VacuumArmIdleState* VacuumArmIdleState::GetState(void)
{
	static VacuumArmIdleState state;
	return &state;
}

// This will set all variables needed for this animation.
void VacuumArmIdleState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("VacuumArm_Idle") );
...
void VacuumArmIdleState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void VacuumArmIdleState::Exit( CComponent_Animation* pComponent )
{
