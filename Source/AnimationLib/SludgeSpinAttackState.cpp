...
SludgeSpinAttackState::~SludgeSpinAttackState(void)
{
}

// Access the state to set it in the state machine for each component.
SludgeSpinAttackState* SludgeSpinAttackState::GetState(void)
{
	static SludgeSpinAttackState state;
	return &state;
}

// This will set all variables needed for this animation.
void SludgeSpinAttackState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("Sludge_SpinAttack") );
...
void SludgeSpinAttackState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SludgeSpinAttackState::Exit( CComponent_Animation* pComponent )
{
