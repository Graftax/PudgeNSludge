...
PudgeSmallDamageState::~PudgeSmallDamageState(void)
{
}

// Access the state to set it in the state machine for each component.
PudgeSmallDamageState* PudgeSmallDamageState::GetState(void)
{
	static PudgeSmallDamageState state;
	return &state;
}

// This will set all variables needed for this animation.
void PudgeSmallDamageState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("Pudge_SmallHurt") );
...
void PudgeSmallDamageState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void PudgeSmallDamageState::Exit( CComponent_Animation* pComponent )
{
