...
SlimeMonsterWalkState::~SlimeMonsterWalkState(void)
{
}

// Access the state to set it in the state machine for each component.
SlimeMonsterWalkState* SlimeMonsterWalkState::GetState(void)
{
	static SlimeMonsterWalkState state;
	return &state;
}

// This will set all variables needed for this animation.
void SlimeMonsterWalkState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation("SlimeMonster_Walk") );
...
void SlimeMonsterWalkState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void SlimeMonsterWalkState::Exit( CComponent_Animation* pComponent )
{
