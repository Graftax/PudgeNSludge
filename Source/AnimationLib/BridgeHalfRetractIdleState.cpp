...
BridgeHalfRetractIdleState::~BridgeHalfRetractIdleState(void)
{
}

// Access the state to set it in the state machine for each component.
BridgeHalfRetractIdleState* BridgeHalfRetractIdleState::GetState(void)
{
	static BridgeHalfRetractIdleState state;
	return &state;
}

// This will set all variables needed for this animation.
void BridgeHalfRetractIdleState::Enter( CComponent_Animation* pComponent )
{
	pComponent->GetInterpolator().SetAnimation( AnimationManager::GetInstance()->GetAnimation( "Bridge_HalfRetractIdle" ) );
...
void BridgeHalfRetractIdleState::Execute( CComponent_Animation* pComponent, float fTime )
{
...
void BridgeHalfRetractIdleState::Exit( CComponent_Animation* pComponent )
{
