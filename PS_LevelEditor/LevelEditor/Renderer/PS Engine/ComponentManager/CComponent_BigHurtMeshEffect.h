#ifndef CCOMPONENT_BIGHURTMESHEFFECT_H_
#define CCOMPONENT_BIGHURTMESHEFFECT_H_
...
__declspec(align(32))
class CComponent_BigHurtMeshEffect : public IComponent
{
private:
	...
	float duration;
public:
	CComponent_BigHurtMeshEffect(void);
	~CComponent_BigHurtMeshEffect(void);
