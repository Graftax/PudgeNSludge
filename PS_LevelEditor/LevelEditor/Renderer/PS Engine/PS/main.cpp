...
#endif
	//MultiThreadRender::GetInstance()->InitRenderEngine( WindowHandle, hInstance, SCREEN_WIDTH, SCREEN_HEIGHT, true, true );
...
HWND BuildWindow(HINSTANCE AppInstance)
{
...
#else
	unsigned int uiStyle = WS_EX_TOPMOST | WS_POPUP /*WS_POPUP | WS_VISIBLE /*| WS_MAXIMIZE*/, uiStyleX = WS_EX_APPWINDOW;// | WS_EX_TOPMOST;
#endif
	...
	HWND WinHandl = CreateWindowEx(uiStyleX, wcex.lpszClassName, (LPCSTR)"Pudge & Sludge", uiStyle,
