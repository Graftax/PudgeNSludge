...
private:
	...
	LPDIRECT3DTEXTURE9 m_pWinGameTexture;
...
public:
	CParticleManager* GetParticleMan() { return particleMan; }
	void SetParticleMan(CParticleManager* val) { particleMan = val; }
